...
from modules.funciones_ml import read_data, load_model
...
def ml():
    ...
    uploaded_file = st.sidebar.file_uploader(label = "Upload your input CSV file",
                                             type  = ["csv"])
    ...
    model, X_scaler, y_scaler = load_model(fuel_type = fuel_type)
    ...
    df_pred["CO2 Emissions"] = prediction_scaled.flatten()
