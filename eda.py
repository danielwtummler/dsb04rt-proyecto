...
def eda():
    ...
    df_sidebar = df if year == "All" else df[df["Model Year"] == year]
    ...
    df_sidebar = df_sidebar if vehicle == "All" else df_sidebar[df_sidebar["Vehicle Class"] == vehicle]
    ...
    col2.plotly_chart(figure_or_data = fig_bar, use_container_width = True)
    col1.plotly_chart(figure_or_data = fig_pie, use_container_width = True)
